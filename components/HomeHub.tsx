                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative flex items-center bg-white/10 backdrop-blur-xl rounded-full shadow-2xl border border-white/20 p-2 pr-4 transition-all focus-within:bg-white/20 focus-within:border-white/40 h-full w-full">
